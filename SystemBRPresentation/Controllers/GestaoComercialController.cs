...
namespace SystemBRPresentation.Controllers
{
    public class GestaoComercialController : Controller
    {
        ...
        public GestaoComercialController(IContratoAppService baseApps, ILogAppService logApps, IMatrizAppService matrizApps)
        {
            baseApp = baseApps;
            logApp = logApps;
        ...
        [HttpPost]
        public ActionResult FiltrarCliente(CONTRATO item)
        {
            try
            {
                // Executa a operação
